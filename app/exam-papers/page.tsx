...
const BOARD_COLORS: Record<string, string> = {
  AQA: "bg-blue-500/20 text-blue-300",
  Edexcel: "bg-pink-500/20 text-pink-300",
  OCR: "bg-amber-500/20 text-amber-300",
};
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="flex flex-wrap items-center gap-4 mb-8 p-4 rounded-xl border border-gray-800 bg-gray-900/40">
          ...
          <label className="flex items-center gap-2 ml-auto cursor-pointer">
            ...
            />
            <span className="text-xs text-gray-400">Show mark schemes</span>
          </label>
        </div>
        ...
        {loading ? (
          ...
          <div className="space-y-8">
            {years.map((year) => (
              <div key={year}>
                <h2 className="text-lg font-bold text-white mb-4">{year}</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {grouped[year].map((paper) => (
                    <div
                      key={paper.id}
                      className="rounded-xl border border-gray-800 bg-gray-900/40 p-4 flex flex-col gap-3"
                    >
                      ...
                      <div className="flex items-center gap-2 mt-auto">
                        ...
                        <button
                          ...
                          className="text-xs bg-gray-800 hover:bg-gray-700 text-gray-300 px-3 py-2 rounded-lg transition-colors flex items-center gap-1.5"
