...
import { SEEDS as gcse } from "./gcse";
import { SEEDS as aLevel } from "./a-level";

export const ENGLISH_SEEDS: SubjectSeeds = {
  "year-3": year3,
  "year-4": year4,
  "year-5": mergeStageSeeds(ks2CurriculumSeeds("year-5", "english"), year5Extra),
  "year-6": mergeStageSeeds(ks2CurriculumSeeds("year-6", "english"), year6Extra),
  "year-7": year7,
  "year-8": year8,
  "year-9": year9,
  gcse,
